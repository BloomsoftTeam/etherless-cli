...
export class KeyManager {
    ...
    encryptKey(data: string, password: string) { return new Promise((resolve, reject) => {_sodium.ready.then(() => {
    ...
    decryptKey() { return new Promise((resolve, reject) => { _sodium.ready.then(() => {
        const sodium = _sodium;
